...
#         for p in player[start:]:
#             if p <= r:
#                 if p==r:
#                     result.append(max_ranked-i)
#                 else:
#                     result.append(max_ranked-i+1)
#                 start+=1
    
#     for i in range(len(player)-start):
#         result.append(1)
...
if __name__ == '__main__':
    ...
    data={}
    # with open(Path(__file__).parent /'test_case.csv') as fp:
